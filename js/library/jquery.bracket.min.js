...
!(function (a) {
    ...
    return {
      highlight: function () {
        e.each(function () {
          a(this).addClass(f),
            a(this).hasClass("win") &&
              a(this).parent().find(".connector").addClass(f);
        });
      },
  ...
  function g(b, c, d) {
    ...
    g &&
      h &&
      (g.name.isEmpty() || f(g.seed.get(), "highlightWinner", b).highlight(),
  ...
  function l(a, b, c, d, e) {
    for (
      var f, g = Math.log(2 * b.length) / Math.log(2), h = b.length, i = 0;
      i < g;
      i += 1
    ) {
    ...
    if (
      c &&
      (a.final().setConnectorCb(u.empty()),
  ...
  function m(a, b, c, d, e) {
    for (
      var f = Math.log(2 * c) / Math.log(2) - 1, g = c / 2, h = 0;
      h < f;
      h += 1
    ) {
      for (var i = d && h === f - 1 ? 1 : 2, j = 0; j < i; j += 1)
        for (var l = b.addRound(u.empty()), m = 0; m < g; m += 1) {
          ...
          if ((p.setAlignCb(D(p.el.find(".teamContainer"), p)), o))
            ...
            var q =
              j % 2 === 0
                ? function (a, b) {
                    var c = a.height() / 4,
                      d = { height: 0, shift: 2 * c };
                    return b
                      .winner()
                      .order.map(function (a) {
                        return a.map(
                          e ? d : { height: 0, shift: c },
                          e ? d : { height: 2 * -c, shift: c }
                        );
                      })
                      .orElse(d);
                  }
    ...
    var g = a.addRound(u.empty()),
      h = g.addMatch(
        ...
        u.of(function (e) {
          var g = !1;
          if (
            d.skipSecondaryFinal ||
            e.winner().name.isEmpty() ||
            e.winner().name !== c.winner().name
          ) {
          ...
          return (
            ...
            k.setAlignCb(function (a) {
              ...
              var e =
                (b.el.height() / 2 + b.el.height() + c.el.height() / 2) / 2 -
                a.height();
              a.css("top", e + "px");
            }),
            !1
  ...
  function q(b) {
    var c = a.extend(!0, {}, b);
    return (
      (c.teams = c.teams.map(function (a) {
  ...
  function r(c, d, e, f, g, h, i, j, k, l) {
    var m =
        e.name.isEmpty() || f.name.isEmpty()
          ? ""
          : 'data-resultid="result-' + j.getNext() + '"',
      n = a(
    ...
    var q = e.name
      ...
      r = a(
        '<div class="team" style="width: ' +
          (i.teamWidth + i.scoreWidth) +
          'px;"></div>'
      ),
      s = a(
        '<div class="label" style="width: ' + i.teamWidth + 'px;"></div>'
      ).appendTo(r);
    if (
      (i.decorator.render(s, e.name.toNull(), p, q),
      ...
      r.append(n),
      (!e.name.isEmpty() || (e.name.isEmpty() && 0 === c && h)) &&
        "function" == typeof i.save &&
        (i.disableTeamEdit ||
          (s.addClass("editable"),
          s.click(function () {
            function b() {
              function f(f, g) {
                ...
                (i.init.teams[~~(h / 2)][h % 2] = u.of(f || null)),
                  ...
                  d.click(b);
                var j = i.el.find(
                  ".team[data-teamid=" + (h + 1) + "] div.label:first"
                );
            ...
            g.val(f),
              ...
              g.keydown(function (c) {
                ...
                if (9 === d || 13 === d || 27 === d) {
                  ...
                  var e = k.find(
                    "div.score[data-resultid=result-" + (w + 1) + "]"
                  );
                  e && e.click();
                }
              }),
              g.blur(function () {
                var a = g.val();
                (a && b(a)) || b(e.score)
                  ? (a && b(a)) || !b(e.score) || (a = e.score)
                  : (a = "0"),
                  d.html(a),
                  b(a) && ((e.score = v.of(parseInt(a, 10))), l(!0)),
                  d.click(c);
              });
          }
          var d = a(this);
  ...
  function s(b, c, d) {
    ...
    if (
      ...
      (c.teams.length > 1 && 1 === c.results.length) ||
        (c.teams.length > 2 && 3 === c.results.length))
    ) {
      var g = a('<span class="decrement">-</span>').appendTo(e);
      g.click(function () {
        if (c.teams.length > 1)
          return (c.teams = c.teams.slice(0, c.teams.length / 2)), K(d);
      });
    }
  ...
  var t,
    ...
    v = (function (a) {
      ...
      return (
        ...
        (b.of = function (a) {
          ...
          if (null !== a && b !== c)
            throw new Error(
              "Invalid score format, expected " + c + ", got " + b
            );
          return u.of(a);
        }),
        (b.empty = function () {
    ...
    w = (function () {
      function a(a, b, c) {
        if (
          ((this.first = a), (this.second = b), (this.userData = c), !a || !b)
        )
  ...
  var x = (function () {
    ...
    y = (function () {
      ...
      return (
        (a.prototype.emptyBranch = function () {
    ...
    z = (function () {
      ...
      return (
        (a.teamsInResultOrder = function (a) {
    ...
    B = function (a, b) {
      return function (c) {
        c.css("top", ""),
          ...
          b
            ? c.css("top", a.el.height() / 2 - c.height() / 2 + "px")
            : c.css("bottom", -c.height() / 2 + "px");
      };
    },
    ...
    E = (function () {
      ...
      return (
        Object.defineProperty(b.prototype, "el", {
          get: function () {
        ...
        (b.prototype.addMatch = function (a, b) {
          var c = this,
            ...
            h = new z(
              new y(f, f().name, u.of(x.first()), f().seed, v.empty()),
              new y(g, g().name, u.of(x.second()), g().seed, v.empty())
            ),
            i = this.mkMatch(
              this,
              h,
              d,
              this._results.map(function (a) {
    ...
    F = (function () {
      ...
      return (
        Object.defineProperty(a.prototype, "el", {
          get: function () {
    ...
    H = (function () {
      ...
      return (
        ...
        (c.prototype.results = function () {
          ...
          return (
            a && (this.match.a.score = this.match.b.score = v.empty()),
    ...
    K = function (b) {
      function c() {
        var a = p(
          j.teams.length,
          k,
          b.skipGrandFinalComeback,
          b.skipSecondaryFinal,
          j.results
        );
        b.disableToolbar
          ? r.css(
              "width",
              a * (b.teamWidth + b.scoreWidth + b.roundMargin) + 10
            )
          : r.css(
              "width",
              a * (b.teamWidth + b.scoreWidth + b.roundMargin) + 40
            ),
          k &&
            j.teams.length <= 2 &&
      ...
      var e,
        ...
        r = a('<div class="jQBracket ' + b.dir + '"></div>').appendTo(
          b.el.empty()
        );
      b.skipSecondaryFinal &&
        k &&
      ...
      k
        ...
        : (b.skipGrandFinalComeback ||
            (t = a('<div class="finals"></div>').appendTo(r)),
          (v = a('<div class="bracket"></div>').appendTo(r)),
      ...
      return (
        (e = new F(v, u.of(j.results[0] || null), x, !0, b)),
        k ||
          ((f = new F(w, u.of(j.results[1] || null), x, !1, b)),
          b.skipGrandFinalComeback ||
            (h = new F(t, u.of(j.results[2] || null), x, !1, b))),
    ...
    M = function (a, b) {
      ...
      if (e !== d)
        throw new Error(
          "Value of " + b + " must be boolean, got " + d + ", got " + e
        );
    },
    N = function (a, b, c) {
      var d = b[c];
      if (d < a)
        throw new Error(
          "Value of " + c + " must be greater than " + a + ", got " + d
        );
    },
    O = function (a) {
      return a & (a - 1);
    ...
    P = {
      init: function (b) {
        ...
        if (
          (void 0 === c.userData && (c.userData = null),
          !(!c.decorator || (c.decorator.edit && c.decorator.render)))
        )
          throw Error("Invalid decorator input");
        c.decorator || (c.decorator = { edit: h, render: i }),
          c.init || (c.init = { teams: [[u.empty(), u.empty()]], results: [] });
        var f = this;
        (c.el = this),
          c.save &&
            (c.onMatchClick || c.onMatchHover) &&
            a.error(
        ...
        j &&
          "boolean" !== g &&
          a.error("disableToolbar must be a boolean, got " + g),
          !c.save &&
            j &&
            a.error(
        ...
        l &&
          "boolean" !== k &&
          a.error("disableTeamEdit must be a boolean, got " + k),
          !c.save &&
            l &&
            a.error(
        ...
        n !== Math.floor(n) &&
          ...
          (c.dir = c.dir || "lr"),
          (c.init.teams =
            c.init.teams && 0 !== c.init.teams.length
              ? c.init.teams
              : [[null, null]]),
          ...
          "lr" !== c.dir &&
            "rl" !== c.dir &&
            a.error('Direction must be either: "lr" or "rl"');
        var o = K(c);
  ...
  a.fn.bracket = function (b) {
    return P[b]
      ? P[b].apply(this, Array.prototype.slice.call(arguments, 1))
      : "object" != typeof b && b
      ? void a.error("Method " + b + " does not exist on jQuery.bracket")
